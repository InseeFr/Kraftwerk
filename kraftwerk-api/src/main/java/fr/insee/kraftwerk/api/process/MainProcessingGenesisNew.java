...
public class MainProcessingGenesisNew extends AbstractMainProcessingGenesis{
     ...
     */
    public void runMainJson(String questionnaireModelId, int batchSize, Mode dataMode, LocalDateTime since)
        ...
        List<InterrogationId> ids =
                fetchInterrogationIds(questionnaireModelId, beginDate);

        runMainJsonInternal(questionnaireModelId, batchSize, dataMode, ids, true);
    }
