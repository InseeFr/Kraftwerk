...
@WebMvcTest(controllers = StepByStepService.class,
...
class StepByStepServiceTest {
    ...
    @Test
    void userKraftwerkShouldNotAccessStepByStepServices() throws Exception {
        mockMvc.perform(put("/buildVtlBindings")
