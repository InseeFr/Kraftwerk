...
public class DDIReaderTest {
	...
	public void readSimpsonsV1Variables() {
		...
		VariablesMap simpsonsVariables = DDIReader.getVariablesFromDDI(
				DDI_FOLDER + "/" + DDI_SIMPSONS_V1);
	...
	public void readVqsWebVariables() {
		...
		VariablesMap vqsVariables = DDIReader.getVariablesFromDDI(
				DDI_FOLDER + "/" + DDI_VQS_WEB);
