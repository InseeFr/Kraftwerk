...
public class BuildBindingsSequence {
	...
	public void buildVtlBindings(UserInputsFile userInputsFile, String dataMode, VtlBindings vtlBindings, MetadataModel metadataModel, boolean withDDI) throws NullException {
