...
public class UnimodalSequence {
	...
	public void applyUnimodalSequence(
		...
		if (modeInputs.getLunaticFile() != null) {
			...
			}catch (NullLunaticFileException e){
				log.warn(e.getMessage());
			}
		} else {
			log.info("No Lunatic questionnaire file for mode \"{}\". Calculated variables will not be evaluated",
					dataMode);
		}
